...
const projects = [
  {
    title: "Insurance Claims Dashboard built using Qliksense",
    cardImage: "assets/images/project-page/Claim.jpg",
    description: "A Financial Dashboard built using Qliksense",
